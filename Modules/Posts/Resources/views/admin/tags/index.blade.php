        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-20">
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.tags.create') }}" class="btn btn-outline-secondary btn-round mb-3" role="button"><i class="fa fa-plus"></i> {{ trans('dashboard::dashboard.form.create') }}
                    </a>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group-sm">
                                        <a href="{{ route('admin.tags.edit', $data->id) }}" title="{{ trans('dashboard::dashboard.form.edit') }}" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                        <a href="{{ route('admin.tags.delete') }}" title="{{ trans('dashboard::dashboard.form.delete') }}" class="btn btn-danger ajax-action" data-method="delete" data-id="{{ $data->id }}"><i class="fa fa-close"></i></a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
