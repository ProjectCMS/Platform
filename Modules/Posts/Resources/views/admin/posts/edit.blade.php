            ...
            <div class="card m-b-20">
                <div class="card-body">
                    <div class="pull-right">
                        <a href="{{ route('admin.posts.create') }}" title="{{ trans('dashboard::dashboard.form.create') }}" class="btn btn-outline-info btn-round"><i class="fa fa-plus"></i>
                            {{ trans('dashboard::dashboard.form.create') }}</a>
                        <a href="{{ route('admin.posts.delete') }}" title="{{ trans('dashboard::dashboard.form.delete') }}" class="btn btn-outline-danger btn-round ajax-action" data-method="delete" data-id="{{ $data->id }}"><i class="fa fa-close"></i> {{ trans('dashboard::dashboard.form.delete') }}
                        </a>
                    </div>
                    ...
                    <div class="card m-b-20">
                        ...
                        <div class="card-footer">
                            @if($data->deleted_at == NULL)
                                <a href="{{ route('admin.posts.trash') }}" title="{{ trans('dashboard::dashboard.form.trash') }}" class="btn btn-link ajax-action" data-method="delete" data-id="{{ $data->id }}"><i class="fa fa-trash"></i>
                                    Mover para lixeira</a>
                            @else
                                <a href="{{ route('admin.posts.restore') }}" title="{{ trans('dashboard::dashboard.form.restore') }}" class="btn btn-link ajax-action" data-method="put" data-id="{{ $data->id }}"><i class="fa fa-refresh"></i>
