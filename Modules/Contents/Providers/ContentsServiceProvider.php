...
class ContentsServiceProvider extends ServiceProvider
{
    ...
    protected function registerConfig()
    {
        ...
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'contents'
        );
    }
    ...
    public function registerViews()
    {
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/contents';
        }, \Config::get('view.paths')), [$sourcePath]), 'contents');
    }
    ...
    {
        $langPath = resource_path('lang/modules/contents');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'contents');
        } else {
