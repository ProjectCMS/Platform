                    ...
                    <div class="row">
                        <div class="col-3">
                            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                                <a class="nav-link active" id="v-pills-home-tab" data-toggle="pill" href="#configuracoes" role="tab" aria-controls="configuracoes" aria-selected="true"><i class="fa fa-cog" aria-hidden="true"></i> Configurações
                                    gerais</a>
                                {{--<a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="#contato" role="tab" aria-controls="contato" aria-selected="false"><i class="fa fa-address-card" aria-hidden="true"></i> Informações de contato</a>--}}
                        ...
                        <div class="col">
                            <div class="tab-content" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="configuracoes" role="tabpanel" aria-labelledby="configuracoes-tab">
                                    ...
                                    <div class="form-group row mb-5">
                                        ...
                                        <div class="col-lg-6 col-sm-9">
                                            ...
                                            <p class="text-muted mb-0 mt-1 ml-2">Em poucas palavras, explique sobre o
                                                que é
                                                esse
                                                site.</p>
                                        </div>
                                    ...
                                    <div class="form-group row mb-5">
                                        ...
                                        <div class="col-lg-6 col-sm-9">
                                            ...
                                            <p class="text-muted mb-1 mt-1 ml-2">Escolha uma cidade no mesmo fuso
                                                horário
                                                que
                                                você
                                                ou o
                                ...
                                <div class="tab-pane fade" id="contato" role="tabpanel" aria-labelledby="contato-tab">...1</div>
