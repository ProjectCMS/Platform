<?php
    ...
    return [
         ...
         */
        'do_not_track_environments'          => [// defaults to none
        ],
         ...
         */
        'do_not_track_ips'                   => [//'127.0.0.0/24', /// range 127.0.0.1 - 127.0.0.255
        ],
         ...
         */
        'log_only_events'          => [// defaults to logging all events
        ],
         ...
         */
        'user_model'               => '\Modules\Clients\Entities\Client',
